...
namespace Hostel_Managment_System.UserControles
{
    ...
    public partial class UC_LivingStudent : UserControl
    {
        DB_Function function = new DB_Function();
        string query;
        public UC_LivingStudent()
        {
            InitializeComponent();
        }

        private void UC_LivingStudent_Load(object sender, EventArgs e)
        {
            query = "select * from NewStudentDetails where Living = 'Yes' ";
        ...
        private void TxtNameSearch_OnValueChanged(object sender, EventArgs e)
        {
            ...
            query = "select * from NewStudentDetails where Living = 'Yes'and Name like '" + TxtNameSearch.Text + "%'";
            DataSet ds = function.GetData(query);
            DataGridView1.DataSource = ds.Tables[0];
        }
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            printer.SubTitle = String.Format("-----------------------------------------" + Environment.NewLine + " All Living Student  Data\n ------------------------------------------ \n" +
                " Date : {0}                                Time : {1}", DateTime.Now.ToString("dd MMMM yyyy"), DateTime.Now.ToString("hh:mm:ss tt"));
            printer.SubTitleFormatFlags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip;
            printer.PageNumbers = true;
            printer.PrintMargins = new System.Drawing.Printing.Margins(10, 5, 30, 15);
        ...
        private void DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // (Name, MobileNo, FathersName, MothersName, ParrentsMobileNo, Email, Gender, CollegeName, CollegeRoll, IDProof, StudyField, RoomNo, Address)
